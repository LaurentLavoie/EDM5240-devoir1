...
"Le Devoir, Le D Magazine,  samedis 26 janvier 2019 658 mots, p. LeD29",
...
#Les phrases ci-dessous semblent bien construites, mais ne s'affichent pas dans mon terminal

print("Le 26 janvier dernier," + str(media) + "a publié dans la section" + str(section) + "à la" + str(page) + "un texte comptant" + str(mots))

print("Le 26 janvier dernier," + str(media) + "a publié à" + string.count(media) + "fois") 
